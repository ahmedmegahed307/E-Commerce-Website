...
let JsProduct =
{
    ...
    Template1: function (item)
    {
        ...
        itemHtml = itemHtml + "<a href='/Details/Index/" + item.tbProductId + "'><img src='/Uploads/" + item.imageName+"'class='img-fluid blur-up lazyload bg-img'alt=''></a>";
        itemHtml = itemHtml + "</div>";
        ...
        itemHtml = itemHtml + " <a href='/ShoppingCart/AddToCart/" + item.tbProductId + " '   > <i class='ti-shopping-cart'></i> </a>";
       itemHtml = itemHtml + "</button>";
        ...
        itemHtml = itemHtml + "<div>";
        itemHtml = itemHtml + "<a href='/Details/Details/"+item.tbProductId+"'>";
        itemHtml = itemHtml + "<h6>"+item.productName+"</h6>";
        itemHtml = itemHtml + "</a>";
        itemHtml = itemHtml + "<h4>$"+item.purchasePrice+ "</h4>";
        itemHtml = itemHtml + "</div>";
        itemHtml = itemHtml + "</div>";
        itemHtml = itemHtml + "</div>";
        itemHtml = itemHtml + "</div>";
